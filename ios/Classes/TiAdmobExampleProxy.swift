...
@objc(TiAdmobExampleProxy)
class TiAdmobExampleProxy: TiProxy {

  override func _init(withPageContext context: TiEvaluator!) -> TiAdmobExampleProxy! {
